...
*/
    ...
    w.Rb = !(!Element.prototype.attachShadow || !Node.prototype.getRootNode);
    var ea = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild");
    w.j = !!(ea && ea.configurable && ea.get);
    w.inUse = w.force || !w.Rb;
    w.noPatch = w.noPatch || !1;
    w.S = w.preferPerformance;
    w.qa = w.noPatch === "on-demand";
    var fa;
    ...
    function Bb(a) {
        Fa();
        return !w.S && this instanceof Node && !ra(document, this) ? (a.__target || Cb(a, this),
    ...
    function dc(a) {
        ...
        if (a && a.localName === "slot") {
            var c = v(a);
            (c = c && c.L) && (b = c.length ? c[0] : dc(a.__shady_nextSibling))
        }
        return b
    }
    function ec(a, b, c) {
    ...
    var ic = C({
        ...
        insertBefore: function(a, b) {
            ...
            h = v(this),
            h.root ? (f = !1,
            la(this) && h.root.u()) : c && this.localName === "slot" && (f = !1,
            c.u()));
        ...
        getRootNode: function(a) {
            if (this && this.nodeType) {
                ...
                b.fa = c) : (c = (c = this.__shady_parentNode) ? c.__shady_getRootNode(a) : this,
                document.documentElement.__shady_native_contains(this) && (b.fa = c)));
                return c
            }
        },
        contains: function(a) {
        ...
        function b() {
            if (d.length > 0) {
                for (; d[d.length - 1] === " "; )
                    d.pop();
                c.push({
                    Ka: d.filter(function(l, m) {
                        return m % 2 === 0
                    }),
                    Ob: d.filter(function(l, m) {
                        return m % 2 === 1
                    })
                });
                d.length = 0
      ...
      , rc = C({
        ...
        querySelectorAll: function(a, b) {
            ...
            if (K === "selectorEngine")
                return ta(qc(this, a));
            if (K === void 0)
                return ta(nc(this, function(d) {
                    return ma.call(d, a)
                }));
            throw Error("Unrecognized value of ShadyDOM.querySelectorImplementation: '" + (K + "'"));
        }
    })
      , sc = w.S && !w.noPatch ? ya({}, J) : J;
    ya(J, rc);
    /*
...
*/
    ...
    function vc(a, b) {
        ...
        la(a) && v(a).root.u()) : a.localName === "slot" && b === "name" && (b = I(a)) && (b.Lb(a),
        b.u())
    }
    var wc = C({
        get previousElementSibling() {
        ...
        setAttribute: function(a, b) {
            this.ownerDocument !== uc ? this.__shady_native_setAttribute(a, b) : Tb(this, a, b) || (this.__shady_native_setAttribute(a, b),
            vc(this, a))
        },
        removeAttribute: function(a) {
            this.ownerDocument !== uc ? this.__shady_native_removeAttribute(a) : Tb(this, a, "") ? this.getAttribute(a) === "" && this.__shady_native_removeAttribute(a) : (this.__shady_native_removeAttribute(a),
            vc(this, a))
        },
        toggleAttribute: function(a, b) {
            if (this.ownerDocument !== uc)
    ...
    var Ac = C({
        attachShadow: function(a) {
            ...
            if (a.shadyUpgradeFragment && !w.Qa) {
    ...
    ya(wc, Ac);
    var Bc = document.implementation.createHTMLDocument("inert")
      , Cc = C({
        get innerHTML() {
        ...
        set innerHTML(a) {
            if (this.localName === "template")
                ...
                b = this.namespaceURI && this.namespaceURI !== Bc.namespaceURI ? Bc.createElementNS(this.namespaceURI, b) : Bc.createElement(b);
    ...
    var Ec = C({
        assignedNodes: function(a) {
            if (this.localName === "slot") {
                ...
                b && y(b) && b.X();
                return (b = v(this)) ? (a && a.flatten ? b.L : b.assignedNodes) || [] : []
            }
        },
    ...
    var Fc = C({
        getElementById: function(a) {
            return a === "" ? null : nc(this, function(b) {
                return b.id == a
            }, function(b) {
                return !!b
            })[0] || null
    ...
    var Kc = window.document
      , Lc = C({
        importNode: function(a, b) {
            if (a.ownerDocument !== Kc || a.localName === "template")
    ...
    var L = {};
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "parentElement") && (L.parentElement = ic.parentElement);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "contains") && (L.contains = ic.contains);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "children") && (L.children = J.children);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML") && (L.innerHTML = Cc.innerHTML);
    Object.getOwnPropertyDescriptor(HTMLElement.prototype, "className") && (L.className = wc.className);
    var M = {
        EventTarget: [Rb],
        Node: [ic, window.EventTarget ? null : Rb],
        Text: [jc],
        Comment: [jc],
        CDATASection: [jc],
        ProcessingInstruction: [jc],
        Element: [wc, J, tc, jc, !w.j || "innerHTML"in Element.prototype ? Cc : null, window.HTMLSlotElement ? null : Ec],
        HTMLElement: [Dc, L],
        HTMLSlotElement: [Ec],
        DocumentFragment: [sc, Fc],
        Document: [Lc, sc, Fc, Jc],
        Window: [Mc],
        CharacterData: [tc],
        XMLHttpRequest: [window.EventTarget ? null : Rb]
    }
      , Nc = w.j ? null : ["innerHTML", "textContent"];
    function N(a, b, c, d) {
    ...
    ;var Qc = w.qa
      , Rc = w.j;
    function Sc(a, b) {
        if (Qc && !a.__shady_protoIsPatched && !y(a)) {
    ...
    function Vc(a, b) {
        ...
        B(a, Cc, b);
        B(a, J, b);
        w.noPatch && !b ? (B(a, ic, b),
        B(a, Fc, b)) : w.j || (B(a, db),
        B(a, bb),
        B(a, cb))
    }
    ;var zc = {}, O = w.deferConnectionCallbacks && document.readyState === "loading", Wc;
    function Xc(a) {
        var b = [];
        do
            b.unshift(a);
    ...
    k.za = function(a, b) {
        ...
        a = u(this.host);
        a.root = this;
        a.Wb = this.mode !== "closed" ? this : null;
        a = u(this);
    ...
    ;
    k.X = function() {
        var a = this.J && this.mb();
        a && a._renderSelf()
    }
    ;
    k.hb = function() {
        !this.ya && this.J && this.X()
    }
    ;
    k._renderSelf = function() {
        ...
        this.g && (this.bb(),
        this.Za());
        if (!w.preferPerformance && !this.ya)
        ...
        for (a = 0; a < this.g.length; a++) {
            ...
            if (!c.assignedNodes.length)
                for (var d = b.__shady_firstChild; d; d = d.__shady_nextSibling)
                    this.va(d, b);
            (d = (d = v(b.__shady_parentNode)) && d.root) && (d.xa() || d.J) && d._renderSelf();
            this.sa(c.L, c.assignedNodes);
            if (d = c.Da) {
                for (var e = 0; e < d.length; e++)
                    v(d[e]).ka = null;
                c.Da = null;
                d.length > c.assignedNodes.length && (c.oa = !0)
            }
            c.oa && (c.oa = !1,
            this.wa(b))
        }
    ...
    k.va = function(a, b) {
        ...
        d !== c.assignedSlot && c.assignedSlot && (u(c.assignedSlot).oa = !0)
    }
    ;
    k.Ya = function(a) {
        var b = v(a)
    ...
    k.Za = function() {
        ...
        for (a = 0; a < b.length; a++)
            c = b[a],
            this.Kb(c === this ? this.host : c, this.ab(c))
    }
    ;
    k.ab = function(a) {
        var b = [];
        for (a = a.__shady_firstChild; a; a = a.__shady_nextSibling)
            if (this.ob(a))
                for (var c = v(a).L, d = 0; d < c.length; d++)
                    b.push(c[d]);
            else
                b.push(a);
        return b
    ...
    k.Kb = function(a, b) {
        for (var c = ua(a), d = Pb(b, b.length, c, c.length), e = 0, f = 0, g = void 0; e < d.length && (g = d[e]); e++) {
            for (var h = 0, l = void 0; h < g.T.length && (l = g.T[h]); h++)
    ...
    k.ta = function(a) {
        this.gb();
        this.F.push.apply(this.F, q(a))
    }
    ;
    k.aa = function() {
        this.F && this.F.length && (this.rb(this.F),
        this.F = [])
    }
    ;
    k.rb = function(a) {
    ...
    k.Fa = function(a) {
        return a.sort(function(b, c) {
            b = Xc(b);
            for (var d = Xc(c), e = 0; e < b.length; e++) {
                c = b[e];
                var f = d[e];
                if (c !== f)
            ...
            for (c in b)
                for (var d = b[c], e = 0; e < d.length; e++) {
                    ...
                    if (sa(a, f)) {
                        ...
                        (g = v(f.__shady_parentNode)) && g.W && g.W--);
                        e--;
                        this.zb(f);
                        g = !0
                    }
        ...
        var Zc = function(a, b, c) {
            ...
            if (b || c)
                a.prototype.connectedCallback = a.prototype.__shadydom_connectedCallback = function() {
                    O ? Yc.set(this, !0) : this[e] || (this[e] = !0,
                    b && b.call(this))
                }
                ,
                a.prototype.disconnectedCallback = a.prototype.__shadydom_disconnectedCallback = function() {
                    O ? this.isConnected || Yc.set(this, !1) : this[e] && (this[e] = !1,
                    c && c.call(this))
                }
                ;
            return a
        }
          , $c = window.customElements.define
          , ad = function(a, b) {
            var c = b.prototype.connectedCallback
              , d = b.prototype.disconnectedCallback;
            $c.call(window.customElements, a, Zc(b, c, d));
            b.prototype.connectedCallback = c;
            b.prototype.disconnectedCallback = d
        };
        window.customElements.define = ad;
    ...
    ;if (w.inUse) {
        ...
        window.ShadyDOM = {
            ...
            wrap: w.noPatch ? dd : ed,
            wrapIfNeeded: w.noPatch === !0 ? dd : function(a) {
                return a
            }
            ,
            Wrapper: P,
        ...
        B(Window.prototype, Mc, "__shady_");
        w.noPatch ? w.qa && B(Element.prototype, Ac) : (Oc(),
        Kb());
        Fb();
        window.Event = Hb;
...
*/
    ...
    function gd(a) {
        var b = a = a.replace(hd, "").replace(id, "")
          , c = new fd;
        c.start = 0;
        c.end = b.length;
    ...
    function jd(a, b) {
        ...
        a.atRule ? c.indexOf("@media") === 0 ? a.type = 4 : c.match(ld) && (a.type = 7,
        a.keyframesName = a.selector.split(kd).pop()) : a.type = c.indexOf("--") === 0 ? 1E3 : 1);
        if (c = a.rules)
    ...
    function _expandUnicodeEscapes$$module$third_party$javascript$polymer$v2$shadycss$src$css_parse(a) {
        return a.replace(/\\([0-9a-f]{1,6})\s/gi, function() {
            for (var b = arguments[1], c = 6 - b.length; c--; )
                b = "0" + b;
            return "\\" + b
        })
    }
    function md(a, b, c) {
        ...
        if (a.cssText || a.rules) {
            ...
            if (e && !_hasMixinRules$$module$third_party$javascript$polymer$v2$shadycss$src$css_parse(e))
                ...
                b = b.replace(nd, "").replace(od, ""),
                b = b.replace(pd, "").replace(qd, "")),
                (d = b.trim()) && (d = "  " + d + "\n")
        }
    ...
    var hd = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim
      ...
      , ld = /^@[^\s]*keyframes/
      , kd = /\s+/g;
    var Q = !(window.ShadyDOM && window.ShadyDOM.inUse), rd;
    function sd(a) {
        rd = a && a.shimcssproperties ? !1 : Q || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"))
    }
    var td;
    window.ShadyCSS && window.ShadyCSS.cssBuild !== void 0 && (td = window.ShadyCSS.cssBuild);
    var R = !(!window.ShadyCSS || !window.ShadyCSS.disableRuntime);
    window.ShadyCSS && window.ShadyCSS.nativeCss !== void 0 ? rd = window.ShadyCSS.nativeCss : window.ShadyCSS ? (sd(window.ShadyCSS),
    window.ShadyCSS = void 0) : sd(window.WebComponents && window.WebComponents.flags);
    var S = rd;
    var ud = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi
      , vd = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi
      , wd = /(--[\w-]+)\s*([:,;)]|$)/gi
      , xd = /(animation\s*:)|(animation-name\s*:)/
      , yd = /@media\s(.*)/
      , zd = /\{[^}]*\}/g;
    var Ad = new Set;
    function T(a, b) {
        if (!a)
            return "";
        typeof a === "string" && (a = gd(a));
        b && Bd(a, b);
        return md(a, S)
    }
    function Cd(a) {
        !a.__cssRules && a.textContent && (a.__cssRules = gd(a.textContent));
    ...
    var Kd = window.ShadyDOM && window.ShadyDOM.wrap || function(a) {
        return a
    }
    ;
    function V(a) {
    ...
    k.Ga = function(a, b, c, d) {
        a.selector = a.o = this.Ha(a, b, c, d)
    }
    ;
    ...
    ;
    k.Ja = function(a) {
        return a.replace(Vd, function(b, c, d) {
    ...
    k.ma = function(a, b, c) {
        ...
        a = a.trim();
        var f = Vd.test(a);
        f && (a = a.replace(Vd, function(l, m, n) {
        ...
        a = a.replace(Xd, ":host $1");
        a = a.replace(Yd, function(l, m, n) {
            e || (l = d.Hb(n, m, b, c),
            e = e || l.stop,
            m = l.Nb,
            n = l.value);
        ...
        g && (a = this.Bb(a, h));
        f && (a = this.Ja(a));
        a = a.replace(Zd, function(l, m, n, t) {
    ...
    k.Hb = function(a, b, c, d) {
        ...
        a.indexOf(":host") >= 0 ? a = this.Jb(a, d) : e !== 0 && (a = c ? this.Ia(a, c) : a);
        c = !1;
        e >= 0 && (b = "",
        c = !0);
        if (c) {
            var f = !0;
            c && (a = a.replace($d, function(g, h) {
                return " > " + h
            }))
        }
        return {
    ...
    k.Jb = function(a, b) {
        var c = a.match(ae);
        return (c = c && c[2].trim() || "") ? c[0].match(be) ? a.replace(ae, function(d, e, f) {
            return b + f
        }) : c.split(be)[0] === b ? c : "should_not_match" : a.replace(":host", b)
    }
    ;
    function ce(a) {
    ...
    k.Ib = function(a) {
        return a.match(":host") ? "" : a.match("::slotted") ? this.ma(a, ":not(.style-scope)") : Od(this.Ia(a.trim(), ":not(.style-scope)"), ":not(.style-scope)")
    }
    ;
    ca.Object.defineProperties(Pd.prototype, {
        V: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    ;
    de.prototype._getStyleRules = de.prototype.nb;
    function fe(a) {
    ...
    var ge = /:host\s*>\s*/
      , he = navigator.userAgent.match("Trident");
    function ie() {}
    function je(a) {
        var b = {}
          , c = []
    ...
    function ke(a) {
        if (!a.l) {
            ...
            le(a, c) && (b.C = c,
            a.rules = null);
            b.cssText = a.parsedCssText.replace(zd, "").replace(ud, "");
            a.l = b
        }
    }
    function le(a, b) {
        ...
        if (c) {
            if (c.C)
                return Object.assign(b, c.C),
                !0
        } else {
            c = a.parsedCssText;
            for (var d; a = ud.exec(c); ) {
                d = (a[2] || a[3]).trim();
    ...
    function me(a, b, c) {
        b && (b = b.indexOf(";") >= 0 ? ne(a, b, c) : Id(b, function(d, e, f, g) {
            if (!e)
                return d + g;
            (e = me(a, c[e], c)) && e !== "initial" ? e === "apply-shim-inherit" && (e = "inherit") : e = me(a, c[f] || f, c) || f;
            return d + (e || "") + g
        }));
        return b && b.trim() || ""
    }
    ...
    function pe(a, b, c, d) {
        ...
        if (b.l.C) {
            ...
            var g = !!f.match(ge) || e === "html" && f.indexOf("html") > -1;
            var h = f.indexOf(":host") === 0 && !g;
            c === "shady" && (g = f === e + " > *." + e || f.indexOf("html") !== -1,
            h = !g && f.indexOf(e) === 0);
            if (g || h)
                c = e,
                h && (b.o || (b.o = W.Ha(b, W.ma, W.ua(a), e)),
                c = b.o || e),
                g && e === "html" && (c = b.o || b.hc),
                d({
                    ra: c,
    ...
    function qe(a, b, c) {
        ...
        Bd(b, function(f) {
            pe(a, f, c, function(g) {
                fe.call(a._element || a, g.ra) && (g.Tb ? le(f, d) : le(f, e))
            })
        }, null, !0);
        return {
            Xb: e,
    ...
    function re(a, b, c, d) {
        ...
        h = h.cssBuild;
        var l = a.cb(b, e, d);
        return Td(b, e, function(m) {
            var n = "";
            m.l || ke(m);
            m.l.cssText && (n = ne(a, m.l.cssText, c));
            m.cssText = n;
            if (!Q && !Dd(m) && m.cssText) {
                var t = n = m.cssText;
                m.La == null && (m.La = xd.test(n));
                if (m.La)
                    if (m.da == null) {
                        m.da = [];
                        for (var A in l)
    ...
    ie.prototype.cb = function(a, b, c) {
        a = b.pb;
        b = {};
        if (!Q && a)
            for (var d = 0, e = a[d]; d < a.length; e = a[++d])
                this.Eb(e, c),
                b[e.keyframesName] = this.qb(e);
        return b
    }
    ;
    ie.prototype.qb = function(a) {
        return function(b) {
            return b.replace(a.Vb, a.Pa)
        }
    }
    ;
    ie.prototype.Eb = function(a, b) {
        a.Vb = new RegExp("\\b" + a.keyframesName + "(?!\\B|-)","g");
        a.Pa = a.keyframesName + "-" + b;
        a.o = a.o || a.selector;
        a.selector = a.o.replace(a.keyframesName, a.Pa)
    }
    ;
    ie.prototype.Fb = function(a, b, c, d) {
        a.o = a.o || a.selector;
        d = "." + d;
        for (var e = Ld(a.o), f = 0, g = e.length, h = void 0; f < g && (h = e[f]); f++)
    ...
    function se(a, b) {
        ...
        a.textContent = T(d, function(e) {
            ...
            e.l && e.l.cssText && (f = f.replace(nd, "").replace(od, ""),
            e.cssText = ne(c, f, b))
        })
    }
    ca.Object.defineProperties(ie.prototype, {
        Ra: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    var te = new ie;
    var ue = {}
      , ve = window.customElements;
    if (ve && !Q && !R) {
        var we = ve.define;
        ve.define = function(a, b, c) {
            ue[a] || (ue[a] = Gd(a));
            we.call(ve, a, b, c)
        }
    }
    ...
    xe.prototype.Mb = function(a, b, c) {
    ...
    xe.prototype.store = function(a, b, c, d) {
        ...
        e.length > this.cc && e.shift();
        this.cache[a] = e
    }
    ;
    xe.prototype.fetch = function(a, b, c) {
        if (a = this.cache[a])
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        var f = e.getRootNode()
                          , g = Ae(e);
                        if (g && f === e.ownerDocument && (e.localName !== "style" && e.localName !== "template" || Md(e) === ""))
                            Sd(e, g);
                        else if (f instanceof ShadowRoot)
                            for (f = Be(e),
                            f !== g && Rd(e, g, f),
                            e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.V + ")"),
                            g = 0; g < e.length; g++) {
                                f = e[g];
                                var h = Be(f);
                                h && W.element(f, h)
    ...
    k.prepareTemplateStyles = function(a, b, c) {
        if (!a._prepared && !R) {
            ...
            var f = this.ib(a) + (Le[b] || "");
            this.N();
            if (!e) {
                var g;
                if (g = !d)
                    g = vd.test(f) || ud.test(f),
                    vd.lastIndex = 0,
                    ud.lastIndex = 0;
                var h = gd(f);
            ...
            S || (g = je(a._styleAst));
            if (!g.length || S)
                b = this.kb(c, a._styleAst, Q ? a.content : null, ue[b] || null, d, e ? f : ""),
                a._style = b;
            a.wb = g
        }
    }
    ...
    ;
    k.kb = function(a, b, c, d, e, f) {
        f = Td(a, b, null, e, f);
        return f.length ? Ed(f, a.is, c, d) : null
    }
    ;
    k.Ca = function(a) {
        var b = V(a)
    ...
    k.fb = function() {
        ...
        this.h.validateCallback = function() {
            requestAnimationFrame(function() {
                (a.h.enqueued || a.ia) && a.flushCustomStyles()
            })
        }
        )
    }
    ...
    k.flushCustomStyles = function() {
        if (!R) {
            ...
            if (this.h) {
                ...
                !a && !this.h.enqueued || Nd(this.B.cssBuild) || (S ? this.B.cssBuild || this.Db(b) : (this.Ab(b),
                this.na(this.I, this.B),
                this.Va(b),
                this.ia && this.styleDocument()),
                this.h.enqueued = !1)
            }
        }
    }
    ...
    k.styleElement = function(a, b) {
        if (R) {
            if (b) {
                X(a) || ee(a, new de(null));
                var c = X(a);
                this.Aa(c, b);
                Ne(this, a, c)
            }
        } else if (c = X(a) || this.Ca(a))
            this.ja(a) || (this.ia = !0),
            b && this.Aa(c, b),
            S ? Ne(this, a, c) : (this.flush(),
            this.na(a, c),
            c.pa && c.pa.length && this.Wa(a, c))
    }
    ;
    k.Aa = function(a, b) {
        a.M = a.M || {};
    ...
    function Ne(a, b, c) {
        ...
        if (((e = Ge[d]) || a.ja(b)) && (!e || Md(e) === "") && e && e._style && !Je(e)) {
            if (Je(e) || e._applyShimValidatingVersion !== e._applyShimNextVersion)
                a.N(),
                a.m && a.m.transformRules(e._styleAst, d),
                e._style.textContent = Td(b, c.A),
                Ke(e);
            Q && (a = b.shadowRoot) && (a = a.querySelector("style")) && (a.textContent = Td(b, c.A));
            c.A = e._styleAst
        }
    }
    k.la = function(a) {
        return (a = Kd(a).getRootNode().host) ? X(a) || this.Ca(a) ? a : this.la(a) : this.I
    }
    ;
    k.ja = function(a) {
        return a === this.I
    ...
    k.Wa = function(a, b) {
        ...
        var h = b.v;
        var l = te;
        g = e ? e.textContent || "" : re(l, a, g, h);
        l = X(a);
        var m = l.K;
        m && !Q && m !== e && (m._useCount--,
        m._useCount <= 0 && m.parentNode && m.parentNode.removeChild(m));
        Q ? l.K ? (l.K.textContent = g,
        e = l.K) : g && (e = Ed(g, h, a.shadowRoot, l.placeholder)) : e ? e.parentNode || (he && g.indexOf("@media") > -1 && (e.textContent = g),
        Fd(e, null, l.placeholder)) : g && (e = Ed(g, h, null, l.placeholder));
    ...
    k.na = function(a, b) {
        var c = this.la(a)
          , d = X(c)
          , e = d.D;
        c === this.I || e || (this.na(c, d),
        e = d.D);
        c = Object.create(e || null);
        e = qe(a, b.A, b.cssBuild);
        a = oe(d.A, a).C;
        Object.assign(c, e.Sb, a, e.Xb);
        this.sb(c, b.M);
        a = te;
    ...
    k.Oa = function(a) {
        ...
        if (!Nd(c)) {
            ...
            S ? a.textContent = T(d) : this.B.A.rules.push(d)
        }
    }
    ;
    k.Cb = function(a) {
    ...
    Y.prototype._styleInfoForNode = Y.prototype.Gb;
    Y.prototype.transformCustomStyleForDocument = Y.prototype.Oa;
    Y.prototype.getStyleAst = Y.prototype.Qb;
    Y.prototype.styleAstToString = Y.prototype.bc;
    Y.prototype.flushCustomStyles = Y.prototype.flushCustomStyles;
    Y.prototype.scopeNode = Y.prototype.Zb;
    Y.prototype.unscopeNode = Y.prototype.dc;
    Y.prototype.scopeForNode = Y.prototype.Yb;
    Y.prototype.currentScopeForNode = Y.prototype.Pb;
    ...
    var Z = new Y, Oe, Pe;
    window.ShadyCSS && (Oe = window.ShadyCSS.ApplyShim,
