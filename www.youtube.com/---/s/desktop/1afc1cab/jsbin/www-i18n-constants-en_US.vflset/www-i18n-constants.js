...
*/
    ...
    function f(c, b) {
        c = c.split(".");
        for (var a = e, d; c.length && (d = c.shift()); )
            c.length || b === void 0 ? a[d] && a[d] !== Object.prototype[d] ? a = a[d] : a = a[d] = {} : a[d] = b
    }
    ;var g = {
        YEAR_FULL: "y",
    ...
    function n(c, b) {
        if (void 0 === b) {
            b = c + "";
            var a = b.indexOf(".");
            b = Math.min(a === -1 ? 0 : b.length - a - 1, 3)
        }
        a = Math.pow(10, b);
        b = {
            g: b,
        ...
        return (c | 0) == 1 && b.g == 0 ? "one" : "other"
    }
    var p = m = m = n;
    f("YT_I18N_FORMATTING_GOOG_LOCALE", "en");
    f("YT_I18N_FORMATTING_DATE_TIME_PATTERNS", h);
    f("YT_I18N_FORMATTING_DATE_TIME_SYMBOLS", l);
    ...
    f("YT_I18N_FORMATTING_PLURAL_RULES_SELECT", p);
