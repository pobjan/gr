...
*/
    ...
    var y = window.performance && window.performance.timing && window.performance.now ? function() {
    ...
    var E = window._spf_state || {};
    window._spf_state = E;
    var F = {};
    "config"in E || D("config", F);
    F = E.config;
    function G(a) {
        var b = H();
        a in b && delete b[a]
    ...
    function J(a) {
        var b = parseInt(E["cache-counter"], 10) || 0;
        b++;
        D("cache-counter", b);
        a.count = b
    }
    function H() {
        return "cache-storage"in E ? E["cache-storage"] : D("cache-storage", {})
    }
    ;function K(a, b) {
    ...
    ;function N(a) {
        a.data && Object.prototype.toString.call(a.data) == "[object String]" && a.data.lastIndexOf("spf:", 0) == 0 && O(a.data.substring(4))
    }
    function O(a) {
        var b = P[a];
        b && (delete P[a],
    ...
    var S = function() {
      ...
      , P = {};
    "async-defers"in E || D("async-defers", P);
    P = E["async-defers"];
    S && ("async-listener"in E && R(E["async-listener"]),
    Q(N),
    D("async-listener", N));
    var T = {};
    "ps-s"in E || D("ps-s", T);
...
*/
    var ja = {}
      , ka = {}
      , la = {};
    "rsrc-s"in E || D("rsrc-s", ja);
    ja = E["rsrc-s"];
    "rsrc-n"in E || D("rsrc-n", ka);
    ka = E["rsrc-n"];
    "rsrc-u"in E || D("rsrc-u", la);
    la = E["rsrc-u"];
    var ma = {};
    "js-d"in E || D("js-d", ma);
    ma = E["js-d"];
...
*/
    function oa(a, b, c) {
        if (b) {
            ...
            c && (a += "\r\n");
            var d = a.indexOf("[\r\n", e);
            for (d > -1 && (e = d + 3); (d = a.indexOf(",\r\n", e)) > -1; ) {
                var f = L(a.substring(e, d));
                e = d + 3;
                f && b.push(JSON.parse(f))
            }
            d = a.indexOf("]\r\n", e);
            d > -1 && (f = L(a.substring(e, d)),
            e = d + 3,
            f && b.push(JSON.parse(f)));
            f = "";
    ...
    function W(a) {
        ...
        if (Object.prototype.toString.call(a) != "[object String]")
            return a.scripts && z(a.scripts, function(c) {
                b.scripts.push({
                    url: c.url || "",
                    text: c.text || "",
                    name: c.name || "",
            ...
            a.styles && z(a.styles, function(c) {
                b.styles.push({
                    url: c.url || "",
                    text: c.text || "",
                    name: c.name || ""
            ...
            b.html = a.html || "",
            b;
        a = a.replace(qa, function(c, e, d, f) {
            if (e == "script") {
                e = (e = d.match(X)) ? e[1] : "";
                var h = d.match(ra);
                h = h ? h[1] : "";
                var k = sa.test(d);
                d = ta.exec(d);
                return (d = !d || d[1].indexOf("/javascript") != -1 || d[1].indexOf("/x-javascript") != -1 || d[1].indexOf("/ecmascript") != -1) ? (b.scripts.push({
                    url: h,
                    text: f,
                    name: e,
                    async: k
            ...
            return e == "style" && (e = (e = d.match(X)) ? e[1] : "",
            d = ta.exec(d),
            d = !d || d[1].indexOf("text/css") != -1) ? (b.styles.push({
                url: "",
                text: f,
                name: e
            }),
        ...
        a = a.replace(ua, function(c, e) {
            var d = e.match(va);
            d = d ? d[1] : "";
            return d == "stylesheet" ? (d = (d = e.match(X)) ? d[1] : "",
            e = (e = e.match(wa)) ? e[1] : "",
            b.styles.push({
                url: e,
                text: "",
            ...
            "") : d == "spf-preconnect" ? (e = (e = e.match(wa)) ? e[1] : "",
            b.links.push({
                url: e,
                rel: d
            }),
    ...
    var ua = /\x3clink([\s\S]*?)\x3e/ig
      , qa = /\x3c(script|style)([\s\S]*?)\x3e([\s\S]*?)\x3c\/\1\x3e/ig
      , sa = /(?:\s|^)async(?:\s|=|$)/i
      , wa = /(?:\s|^)href\s*=\s*["']?([^\s"']+)/i
      , X = /(?:\s|^)name\s*=\s*["']?([^\s"']+)/i
      , va = /(?:\s|^)rel\s*=\s*["']?([^\s"']+)/i
    ...
    function xa(a, b, c, e) {
        ...
        g.onreadystatechange = function() {
            var q = g.timing;
            if (g.readyState == 2) {
                q.responseStart = q.responseStart || y();
                if (g.responseType == "json")
                    f = !1;
                else if (F["assume-all-json-requests-chunked"] || (g.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked") > -1)
                    f = !0;
                else {
                ...
                g.readyState == 3 ? f && d.l && (q = g.responseText.substring(h),
                h = g.responseText.length,
                d.l(g, q)) : g.readyState == 4 && (q.responseEnd = q.responseEnd || y(),
        ...
        ;
        "responseType"in g && d.responseType == "json" && (g.responseType = "json");
        ...
        d.C > 0 && (k = setTimeout(function() {
            g.abort();
            d.A && d.A(g)
        }, d.C));
        g.timing.fetchStart = y();
        g.send(c);
        return g
    }
    ;function ya(a, b, c, e, d) {
        var f = !1;
        c.responseStart = c.responseEnd = y();
        b.type && b.type.lastIndexOf("navigate", 0) == 0 && (c.navigationStart = c.startTime,
        F["cache-unified"] || (G(e),
        f = !0));
        b.j && d.type == "multipart" && z(d.parts, function(h) {
            h.timing || (h.timing = {});
    ...
    function Aa(a, b, c) {
        ...
        b.h = a.toLowerCase().indexOf("multipart") != -1
    }
    function Ba(a, b, c, e, d, f, h) {
        if (e.h) {
            f = e.g + f;
            try {
                var k = oa(f, !0, h)
    ...
    function Ca(a, b, c, e, d) {
        ...
        if (d.resourceTiming)
            ...
            f + d.resourceTiming.startTime >= c.startTime))
                for (var k in d.resourceTiming)
                    ...
                    h !== void 0 && (K(k, "Start") || K(k, "End") || k == "startTime") && (c[k] = f + Math.round(h));
        b.type != "load" && (c.navigationStart = c.startTime);
        e.complete.length && (e.g = L(e.g),
        e.g && Ba(a, b, c, e, d, "", !0));
        if (d.responseType == "json") {
            ...
            var g = V(C(d.response))
        } else
            try {
                g = oa(d.responseText).m
            } catch (t) {
                b.i && b.i(a, t, d);
                return
            }
        if (b.j && g.length > 1)
            for (e = e.complete.length; e < g.length; e++)
                d = g[e],
                d.timing || (d.timing = {}),
    ...
    function za(a, b, c, e, d) {
        if (d && b.method != "POST" && (d = Da(a, b.current, e.cacheType, b.type, !0))) {
            e.cacheKey = d;
            var f = {
                response: e,
                type: b.type || ""
            }
              , h = parseInt(F["cache-lifetime"], 10)
              , k = parseInt(F["cache-max"], 10);
            h <= 0 || k <= 0 || (k = H(),
            f = {
                data: f,
                life: h,
    ...
    function Da(a, b, c, e, d) {
        a = ia(a);
        var f;
        F["cache-unified"] ? f = a : e == "navigate-back" || e == "navigate-forward" ? f = "history " + a : e == "navigate" ? f = (d ? "history " : "prefetch ") + a : e == "prefetch" && (f = d ? "prefetch " + a : "");
        b && c == "url" ? f += " previous " + b : b && c == "path" && (f += " previous " + U(b).pathname);
        return f || ""
    }
    function Ea(a, b) {
        var c = [];
        b && (c.push(a + " previous " + b),
        c.push(a + " previous " + U(b).pathname));
        c.push(a);
        var e = null;
        A(c, function(d) {
            a: {
    ...
    function Ia(a, b, c) {
        var e;
        (e = c.type == "multipart") || (e = Y((a || {}).onProcess, {
            url: b,
            response: c
        }));
        e && Y((a || {}).onDone, {
    ...
    var Ja = {
        request: function(a, b) {
            ...
            if (e) {
                ...
                if (e.lastIndexOf("?", 0) == 0)
                    ...
                    if (e.lastIndexOf(".", 0) == 0)
                        ...
                        K(c, "/") && e.lastIndexOf("/", 0) == 0 && (e = e.substring(1));
                    c += e
                }
                c = c + h + f + k + d
            }
            ...
            h = Da(a, b.current, null, b.type, !1);
            h = Ea(h, b.current);
            c.spfPrefetched = !!h && h.type == "prefetch";
            c.spfCached = !!h;
            if (h) {
                a = x(ya, null, a, b, c, h.key, h.response);
                b = window._spf_state = window._spf_state || {};
                var m = parseInt(b.uid, 10) || 0;
                m++;
                b = b.uid = m;
                P[b] = a;
                S ? window.postMessage("spf:" + b, "*") : window.setTimeout(x(O, null, b), 0);
                a = null
            } else {
                h = {};
                if (f = F["request-headers"])
                    for (m in f)
                        k = f[m],
                        h[m] = k == null ? "" : String(k);
                if (b.headers)
                    for (m in b.headers)
                        k = b.headers[m],
                        h[m] = k == null ? "" : String(k);
                b.B != null && (h["X-SPF-Referer"] = b.B);
                b.current != null && (h["X-SPF-Previous"] = b.current);
                if (m = F["advanced-header-identifier"])
                ...
                F["advanced-response-type-json"] && (a.responseType = "json");
                a = b.method == "POST" ? xa("POST", e, b.D, a) : xa("GET", e, null, a)
            }
            return a
        }
    }
