...
*/
    ...
    function f(b, c) {
        b = b.split(".");
        for (var a = e, d; b.length && (d = b.shift()); )
            b.length || c === void 0 ? a[d] && a[d] !== Object.prototype[d] ? a = a[d] : a = a[d] = {} : a[d] = c
    }
    ;var g = {
        YEAR_FULL: "y",
    ...
    function l(b, c) {
        if (void 0 === c) {
            c = b + "";
            var a = c.indexOf(".");
            c = Math.min(a === -1 ? 0 : c.length - a - 1, 3)
        }
        a = Math.pow(10, c);
        return {
            g: c,
    ...
    k = function(b, c) {
        c = l(b, c);
        return (b | 0) == 1 && c.g == 0 ? "one" : "other"
    }
    ;
    var m = k = function(b, c) {
        var a = b | 0;
        b = l(b, c);
        return a == 1 && b.g == 0 ? "one" : b.g == 0 && a % 10 >= 2 && a % 10 <= 4 && (a % 100 < 12 || a % 100 > 14) ? "few" : b.g == 0 && a != 1 && a % 10 >= 0 && a % 10 <= 1 || b.g == 0 && a % 10 >= 5 && a % 10 <= 9 || b.g == 0 && a % 100 >= 12 && a % 100 <= 14 ? "many" : "other"
    }
    ;
    f("YT_I18N_FORMATTING_GOOG_LOCALE", "pl");
    ...
    f("YT_I18N_FORMATTING_PLURAL_RULES_SELECT", m);
    f("YT_I18N_FORMATTING_DURATION_TIME_SYMBOLS", {
        DAY: {
            LONG: "one{# dzie\u0144}few{# dni}many{# dni}other{# dnia}",
            SHORT: "one{# dzie\u0144}few{# dni}many{# dni}other{# dnia}",
