...
*/
    ...
    ;var ka = globalThis.trustedTypes, la;
    function ma() {
        var a = null;
        if (!ka)
            return a;
    ...
    ;function va(a, b) {
        if (a.nodeType === 1) {
            var c = a.tagName;
            if (/^(script|style)$/i.test(c))
                throw a = c.toLowerCase() === "script" ? "Use setScriptTextContent with a SafeScript." : "Use setStyleTextContent with a SafeStyleSheet.",
                Error(a);
        }
        if (b instanceof ta)
            b = b.g;
    ...
    Ka = x["async-defers"];
    Na && ("async-listener"in x && Ma(x["async-listener"]),
    La(Ia),
    w("async-listener", Ia));
    var Oa = {
    ...
    function E(a, b) {
        b && (a.classList ? a.classList.add(b) : Va(a, b) || (a.className += " " + b))
    }
    function F(a, b) {
        if (b)
            if (a.classList)
    ...
    function ab(a, b, c, d) {
        if (b || c) {
            ...
            if (a)
                bb(c, b);
            else if (a = cb().contentWindow.history.pushState,
            typeof a == "function")
    ...
    function db(a) {
        ...
        if (x["history-ignore-pop"])
            ...
            bb(a, b)) : (a["spf-back"] = c < parseInt(x["history-timestamp"], 10),
    ...
    function mb(a, b, c) {
        b.delay ? (c = n(c, null, Aa),
        a.A = setTimeout(c, b.delay),
        b.delay = 0) : (a.items.shift(),
        c = n(c, null, b.K),
        (b = (b = A["advanced-task-scheduler"]) && b.addTask) ? a.B = b(c) : a.A = setTimeout(c, 0))
    }
    function lb(a) {
        if (a.B) {
...
*/
    function qb(a, b, c, d) {
        ...
        eb(g, d);
        d = n(sb, null, a);
        T[P(a, b)] ? (e && f != e && (a = tb(a, b)) && a.setAttribute("name", c || ""),
        d()) : (a = ub(a, b, d, void 0, void 0, h)) && c && a.setAttribute("name", c)
    }
    function vb(a, b) {
        var c = Q[P(a, b)];
        delete Q[P(a, b)];
    ...
    function sb(a) {
        var b = P(a, ""), c;
        for (c in G)
            c.indexOf(b) == 0 && Ba(c.substring(b.length).split("|"), n(xb, null, a)) && gb(c)
    }
    function ub(a, b, c, d, e, f) {
        ...
        m.href = b,
        (f = f ? tb(a, f, d) : null) ? d.insertBefore(m, f) : d.appendChild(m));
        return m
    }
    function wb(a, b) {
        b = O(a, b);
    ...
    function Cb(a, b, c, d, e) {
        ...
        Db ? a.createElement("script").src = c : h.data = c,
        h.id = d,
        a.body.appendChild(h)) : g ? (h = ub(b, c, null, a, e),
    ...
    function Gb(a, b) {
        ...
        a == "js" ? (a = document.createElement("script"),
        a.text = b,
        c.appendChild(a),
...
*/
    function Wb(a, b, c) {
        if (b) {
            ...
            c && (a += "\r\n");
            var e = a.indexOf("[\r\n", d);
            for (e > -1 && (d = e + 3); (e = a.indexOf(",\r\n", d)) > -1; ) {
                var f = Ga(a.substring(d, e));
                d = e + 3;
                f && b.push(JSON.parse(f))
            }
            e = a.indexOf("]\r\n", d);
            e > -1 && (f = Ga(a.substring(d, e)),
            d = e + 3,
            f && b.push(JSON.parse(f)));
            f = "";
        ...
        b.attr && (u = n(function(t, C) {
            for (var H in t) {
                ...
                if (M) {
                    ...
                    for (R in bc) {
                        var ra = bc[R];
                        R == "class" ? M.className = ra : R == "style" ? M.style.cssText = ra : (M.setAttribute(R, ra),
                        R == "value" && (M[R] = ra))
                    }
                }
            }
        ...
        for (Ua in I)
            u = n(function(t, C) {
                if (t = document.getElementById(t)) {
                    ...
                    C = A["animation-class"];
                    ac && Va(t, C) ? (t = new cc(t,H.html,C,k,!!f),
                    ib(m),
                    L(t.key, !0),
                    J(t.key, n(dc, null, t), 0),
                    J(t.key, n(ec, null, t), 17),
                    J(t.key, n(fc, null, t), t.duration),
                    J(t.key, n(function() {
                        M();
                        jb(m, B)
                    }, null), 0),
                    L(t.key)) : (C = A["experimental-html-handler"]) ? (ib(m),
                    C(H.html, t, function() {
                        M();
                        jb(m, B)
                    })) : (va(t, wa(H.html)),
    ...
    function dc(a) {
        ...
        va(a.u, wa(a.V));
        a.reverse ? (b = a.v,
        b.parentNode.insertBefore(a.u, b)) : (b = a.v,
        b.parentNode.insertBefore(a.u, b.nextSibling))
    }
    function ec(a) {
        F(a.g, a.T);
        F(a.g, a.U);
    ...
    function W(a) {
        ...
        if (!Fa(a))
            ...
            b.html = a.html || "",
            b;
        a = a.replace(lc, function(c, d, e, f) {
            if (d == "script") {
                d = (d = e.match(mc)) ? d[1] : "";
                var g = e.match(nc);
                g = g ? g[1] : "";
            ...
            return d == "style" && (d = (d = e.match(mc)) ? d[1] : "",
            e = pc.exec(e),
            e = !e || e[1].indexOf("text/css") != -1) ? (b.styles.push({
                url: "",
                text: f,
                name: d
            }),
        ...
        a = a.replace(qc, function(c, d) {
            var e = d.match(rc);
            e = e ? e[1] : "";
            return e == "stylesheet" ? (e = (e = d.match(mc)) ? e[1] : "",
            d = (d = d.match(sc)) ? d[1] : "",
            b.styles.push({
                url: d,
                text: "",
            ...
            "") : e == "spf-preconnect" ? (d = (d = d.match(sc)) ? d[1] : "",
            b.links.push({
                url: d,
                rel: e
            }),
    ...
    var ac = function() {
      ...
      , qc = /\x3clink([\s\S]*?)\x3e/ig
      , lc = /\x3c(script|style)([\s\S]*?)\x3e([\s\S]*?)\x3c\/\1\x3e/ig
      , oc = /(?:\s|^)async(?:\s|=|$)/i
      , sc = /(?:\s|^)href\s*=\s*["']?([^\s"']+)/i
      , mc = /(?:\s|^)name\s*=\s*["']?([^\s"']+)/i
      , rc = /(?:\s|^)rel\s*=\s*["']?([^\s"']+)/i
    ...
    function tc(a, b, c, d) {
        ...
        k.onreadystatechange = function() {
            ...
            if (k.readyState == 2) {
                ...
                if (k.responseType == "json")
                    f = !1;
                else if (A["assume-all-json-requests-chunked"] || (k.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked") > -1)
                    f = !0;
                else {
                ...
                k.readyState == 3 ? f && e.D && (u = k.responseText.substring(g),
                g = k.responseText.length,
                e.D(k, u)) : k.readyState == 4 && (u.responseEnd = u.responseEnd || q(),
                window.performance && window.performance.getEntriesByName && (k.resourceTiming = window.performance.getEntriesByName(b).pop()),
                f && e.D && k.responseText.length > g && (u = k.responseText.substring(g),
                g = k.responseText.length,
                e.D(k, u)),
                clearTimeout(h),
                e.O && e.O(k))
        ...
        ;
        "responseType"in k && e.responseType == "json" && (k.responseType = "json");
    ...
    ;function uc(a, b) {
        ...
        if (d) {
            ...
            if (d.lastIndexOf("?", 0) == 0)
                ...
                if (d.lastIndexOf(".", 0) == 0)
                    ...
                    y(c, "/") && d.lastIndexOf("/", 0) == 0 && (d = d.substring(1));
                c += d
            }
            c = c + g + f + h + e
        }
        ...
        g = vc(a, b.current, null, b.type, !1);
        g = wc(g, b.current);
        c.spfPrefetched = !!g && g.type == "prefetch";
        c.spfCached = !!g;
        if (g) {
            a = n(xc, null, a, b, c, g.key, g.response);
        ...
        return b.method == "POST" ? tc("POST", d, b.I, a) : tc("GET", d, null, a)
    }
    function xc(a, b, c, d, e) {
        var f = !1;
        c.responseStart = c.responseEnd = q();
        b.type && b.type.lastIndexOf("navigate", 0) == 0 && (c.navigationStart = c.startTime,
        A["cache-unified"] || (Pa(d),
        f = !0));
        b.m && e.type == "multipart" && r(e.parts, function(g) {
            g.timing || (g.timing = {});
    ...
    function Ac(a, b, c) {
        ...
        b.g = a.toLowerCase().indexOf("multipart") != -1
    }
        ...
        if (e.resourceTiming)
            ...
            f + e.resourceTiming.startTime >= c.startTime))
                for (var h in e.resourceTiming)
                    ...
                    g !== void 0 && (y(h, "Start") || y(h, "End") || h == "startTime") && (c[h] = f + Math.round(g));
        b.type != "load" && (c.navigationStart = c.startTime);
        d.complete.length && (d.j = Ga(d.j),
        d.j && Bc(a, b, c, d, e, "", !0));
        if (e.responseType == "json") {
            if (!e.response) {
                b.l && b.l(a, Error("JSON response parsing failed"), e);
                return
            }
            var k = Xb(v(e.response))
        } else
            try {
                k = Wb(e.responseText).G
            } catch (B) {
                b.l && b.l(a, B, e);
                return
            }
        if (b.m && k.length > 1)
            for (d = d.complete.length; d < k.length; d++)
                e = k[d],
                e.timing || (e.timing = {}),
    ...
    function Cc(a, b, c, d, e) {
        if (e && b.method != "POST" && (e = vc(a, b.current, d.cacheType, b.type, !0))) {
            d.cacheKey = e;
            var f = {
                response: d,
                type: b.type || ""
    ...
    function wc(a, b) {
        ...
        c.push(a + " previous " + nb(b).pathname));
        c.push(a);
        var d = null;
        Ca(c, function(e) {
            a: {
    ...
    ;function Dc(a) {
        return Ya(a, function(b) {
            return Va(b, A["link-class"])
        })
    }
    function Ec(a) {
        return Ya(a, function(b) {
            return Va(b, A["nolink-class"])
        })
    }
    function Fc(a, b) {
    ...
    function Gc(a) {
        if (a.metaKey || a.altKey || a.ctrlKey || a.shiftKey || a.button > 0)
            return null;
        var b = Dc(a.target);
        return !b || A["nolink-class"] && Ec(a.target) ? null : (a = Fc(a.target, b)) ? a.href : null
    }
    function Hc(a) {
    ...
    function Lc(a, b, c) {
        Sc();
        if (Jc(a, c.current))
            if (Tc(a, c.i, c.current, b)) {
                w("nav-counter", (parseInt(x["nav-counter"], 10) || 0) + 1);
                Uc(a);
                var d = N(a)
                  , e = "preprocess " + N(d);
                for (f in K)
                    e != f && f.lastIndexOf("preprocess", 0) == 0 && kb(f);
                d = Vc()[d];
                w("nav-request", d);
                w("nav-promote", null);
                ...
                if (d && d.readyState != 4)
                    ...
                    kb(d),
                    L(e, !0),
                    c.history || Wc(a, c.i, n(Y, null, b));
                else {
                    d = n(Y, null, b);
                    e = n(Xc, null, b, c);
                    var f = n(Yc, null, b, c);
                    A["advanced-navigate-persist-timing"] || Zc();
                    c.type = "navigate";
    ...
    function X(a, b, c) {
        ...
        setTimeout(function() {
            ...
            Jc(a, e) || window.location.reload()
        }, 0)
    }
    function hd(a, b, c) {
        c.h = c.h || a;
        if (Tc(a, void 0, void 0, b, !0)) {
            var d = n(id, null, !1, b, c)
              , e = n(jd, null, !1, b, c)
              , f = n(kd, null, !1, b, c);
            c.type = "load";
            uc(a, {
    ...
    function id(a, b, c, d, e) {
        a && md(d);
        a && x["nav-promote"] == c.h ? Y(b, d, e) : ad(d, e, b, !0)
    }
    ...
    var Zc, od = window.performance && (window.performance.clearResourceTimings || window.performance.webkitClearResourceTimings || window.performance.mozClearResourceTimings || window.performance.msClearResourceTimings || window.performance.oClearResourceTimings);
    Zc = od ? n(od, window.performance) : Aa;
    function Vc() {
    ...
    ;function pd() {
        zb("js");
        zb("css");
        document.readyState == "complete" && (document.removeEventListener ? document.removeEventListener("DOMContentLoaded", pd, !1) : document.detachEvent && document.detachEvent("onreadystatechange", pd))
    }
    document.addEventListener ? document.addEventListener("DOMContentLoaded", pd, !1) : document.attachEvent && document.attachEvent("onreadystatechange", pd);
    pd();
    var qd = {
        init: function(a) {
            ...
            if (b) {
                ...
                w("nav-init-time", q()),
                w("nav-counter", 0),
                document.addEventListener("click", Kc, !1),
                w("nav-listener", Kc),
                !A["experimental-prefetch-mousedown"] || "ontouchstart"in window || window.navigator.maxTouchPoints > 0 || window.navigator.msMaxTouchPoints > 0 || (document.addEventListener("mousedown", Nc, !1),
                w("nav-mousedown-listener", Nc)),
                document.addEventListener("scroll", Pc, !1),
                w("nav-scroll-listener", Pc))
            }
            return b
        },
        dispose: function() {
            typeof History != "undefined" && History.prototype.pushState && (Sc(),
        ...
        navigate: function(a, b) {
            a && (a = pb(a),
            Hc(a) ? Ic() ? Lc(a, b || {}, new Mc) : X(a, "1") : X(a, "9"))
        },
        load: function(a, b) {
            a = pb(a);
            hd(a, b || {}, new Mc)
